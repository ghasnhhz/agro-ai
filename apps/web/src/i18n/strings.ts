...
export const strings: Record<string, Entry> = {
  ...
  // ---- Marketplace ----
  'mk.title': { uz: 'Yer bozori', ru: 'Земельная биржа', en: 'Land Marketplace' },
  'mk.feed.empty.title': { uz: 'Hozircha e’lon yo‘q', ru: 'Пока нет объявлений', en: 'No listings yet' },
  'mk.feed.empty.hint': { uz: 'Birinchi bo‘lib yer joylang', ru: 'Разместите землю первым', en: 'Be the first to post land' },
  'mk.new': { uz: 'Yer joylash', ru: 'Разместить землю', en: 'Post land' },
  'mk.mine': { uz: 'Mening e’lonlarim', ru: 'Мои объявления', en: 'My listings' },
  'mk.filters': { uz: 'Filtrlar', ru: 'Фильтры', en: 'Filters' },
  'mk.filter.allRegions': { uz: 'Barcha viloyatlar', ru: 'Все регионы', en: 'All regions' },
  'mk.filter.anyWater': { uz: 'Har qanday suv', ru: 'Любая вода', en: 'Any water' },
  'mk.filter.minSize': { uz: 'Min (sotka)', ru: 'Мин (сотка)', en: 'Min (sotka)' },
  'mk.filter.maxSize': { uz: 'Max (sotka)', ru: 'Макс (сотка)', en: 'Max (sotka)' },
  'mk.filter.apply': { uz: 'Qo‘llash', ru: 'Применить', en: 'Apply' },
  'mk.filter.clear': { uz: 'Tozalash', ru: 'Сбросить', en: 'Clear' },
  'mk.size': { uz: 'Maydon', ru: 'Площадь', en: 'Size' },
  'mk.sotka': { uz: 'sotka', ru: 'сотка', en: 'sotka' },
  'mk.water': { uz: 'Suv', ru: 'Вода', en: 'Water' },
  'mk.location': { uz: 'Manzil', ru: 'Адрес', en: 'Location' },
  'mk.terms': { uz: 'Ijara shartlari', ru: 'Условия аренды', en: 'Rental terms' },
  'mk.contact': { uz: 'Egasi bilan bog‘lanish', ru: 'Связаться с владельцем', en: 'Contact owner' },
  'mk.status.active': { uz: 'Faol', ru: 'Активно', en: 'Active' },
  'mk.status.closed': { uz: 'Yopilgan', ru: 'Закрыто', en: 'Closed' },
  // form
  'mk.form.new': { uz: 'Yangi e’lon', ru: 'Новое объявление', en: 'New listing' },
  'mk.form.edit': { uz: 'E’lonni tahrirlash', ru: 'Редактировать', en: 'Edit listing' },
  'mk.form.titleField': { uz: 'Sarlavha', ru: 'Заголовок', en: 'Title' },
  'mk.form.titlePh': { uz: 'Masalan: Xorazmda 50 sotka yer', ru: 'Напр.: 50 соток в Хорезме', en: 'e.g. 50 sotka in Khorezm' },
  'mk.form.region': { uz: 'Viloyat', ru: 'Регион', en: 'Region' },
  'mk.form.locationPh': { uz: 'Tuman, mo‘ljal', ru: 'Район, ориентир', en: 'District, landmark' },
  'mk.form.size': { uz: 'Yer maydoni', ru: 'Площадь земли', en: 'Land size' },
  'mk.form.termsPh': { uz: 'Narx yoki kutilgan shartlar', ru: 'Цена или ожидаемые условия', en: 'Price or expected terms' },
  'mk.form.contact': { uz: 'Telegram (ixtiyoriy)', ru: 'Telegram (необязательно)', en: 'Telegram (optional)' },
  'mk.form.contactPh': { uz: 'username (bo‘sh = sizniki)', ru: 'username (пусто = ваш)', en: 'username (blank = yours)' },
  'mk.form.photos': { uz: 'Rasmlar (1–5)', ru: 'Фото (1–5)', en: 'Photos (1–5)' },
  'mk.form.addPhoto': { uz: '+ Rasm qo‘shish', ru: '+ Добавить фото', en: '+ Add photo' },
  'mk.form.submit': { uz: 'E’lonni joylash', ru: 'Опубликовать', en: 'Publish listing' },
  'mk.form.save': { uz: 'Saqlash', ru: 'Сохранить', en: 'Save' },
  'mk.form.uploading': { uz: 'Rasm yuklanmoqda…', ru: 'Загрузка фото…', en: 'Uploading photos…' },
  'mk.edit': { uz: 'Tahrirlash', ru: 'Редактировать', en: 'Edit' },
  'mk.close': { uz: 'Yopish', ru: 'Закрыть', en: 'Close' },
  'mk.reopen': { uz: 'Qayta ochish', ru: 'Открыть снова', en: 'Reopen' },
  'mk.delete': { uz: 'O‘chirish', ru: 'Удалить', en: 'Delete' },
  'mk.delete.confirm': { uz: 'E’lon o‘chirilsinmi?', ru: 'Удалить объявление?', en: 'Delete this listing?' },
  'mk.mine.empty': { uz: 'Sizda hali e’lon yo‘q', ru: 'У вас пока нет объявлений', en: "You don't have any listings yet" },
